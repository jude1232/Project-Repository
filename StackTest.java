...
public class StackTest {
	...
	@Rule
    public Timeout timeout = Timeout.millis(10000000);
    ...
    @Test 
    public void testStack_OneElementStack() 
    {
        stack.push("A");
        stack.pop();
    ...
    public void testStackPeek()
    {
        ...
        stack.push("B");
        stack.push("C");
        assertEquals("Pushing A, B, then C onto stack, and peeking at the top","C", stack.peek());
    }
}